...
import ru.ggproject.happyweather.business.model.Current
...
import ru.ggproject.happyweather.databinding.ActivityMainBinding
import ru.ggproject.happyweather.presenters.MainPresenter
import ru.ggproject.happyweather.view.*
import ru.ggproject.happyweather.view.adapters.MainDailyListAdapter
import ru.ggproject.happyweather.view.adapters.MainHourlyListAdapter
...
class MainActivity : MvpAppCompatActivity(), MainView {
    ...
    override fun displayCurrentData(data: WeatherDataModel) {
        data.apply {
            ...
            binding.mainWindSpeedMuTv.text = StringBuilder().append(current.wind_speed.toString()).append(" м.с.").toString()
    ...
    private val geoCallback = object : LocationCallback() {
        override fun onLocationResult (geo : LocationResult) {
            for (location in geo.locations) {
                mLocations = location
                mainPresenter.refresh(mLocations.latitude.toString(), mLocations.longitude.toString())
            }
        }
    }
